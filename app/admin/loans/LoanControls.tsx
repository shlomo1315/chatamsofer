...
//
// ⚠️ מיוצא כדי שהסינון בכותרת הטבלה יציג בדיוק את התוויות שהמשתמש
// רואה בשורות. שכפול הרשימה שם היה מתפצל ביום שתווית משתנה — ובפרט
// approved/active/completed שכולם "מאושר" אחד.
export const PILL: Record<string, { label: string; cls: string; icon: typeof Clock }> = {
