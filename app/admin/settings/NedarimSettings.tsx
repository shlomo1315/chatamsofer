      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-3" dir="rtl">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <br />
            <span className="text-amber-600">מעבר למפתח API אישי:</span> נדרים חוסמים את סיסמת ה-API הישנה. צרו מפתח חדש בנדרים
            (עוד ← מפתחות API ← מפתח חדש), והדביקו אותו כאן ב״קוד API״ ושמרו — הערך כאן גובר על הגדרת השרת (Railway).
          </p>
