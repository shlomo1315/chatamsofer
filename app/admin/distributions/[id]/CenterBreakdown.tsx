...
const PHASE_HINT: Record<PickupPhase, string> = {
  ...
  ended: 'בטלפון: "שימו לב, החלוקה במוקד שלכם כבר הסתיימה, אין אפשרות לקבל כעת כרטיס. עמכם הסליחה"',
}
                ...
                {phase !== 'active' && (
                  <div className={`mt-2 flex flex-wrap items-center gap-2 rounded-lg px-2.5 py-1.5 ${
                    ...
                    <span className={`min-w-[12rem] flex-1 text-[11px] leading-snug ${
                      ...
                      {phase === 'ended'
                        ? '"שימו לב, החלוקה במוקד שלכם כבר הסתיימה, אין אפשרות לקבל כעת כרטיס. עמכם הסליחה"'
