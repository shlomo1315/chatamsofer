...
// ─────────────────────────────────────────────────────────────────────────────
// force-dynamic — העמוד נבנה מחדש בכל בקשה.
//
// המסך נושא נתונים שמשתנים בכל רגע (רישומים, שיוכי מוקד, טעינות), ואין
// שום ערך בהגשת HTML מוטמן. כל נתיבי ה-API של המסך כבר מוגדרים כך;
// העמוד עצמו נשכח.
//
// ⚠️ זה *אינו* מה שתיקן את "מוקד שנבחר באתר מוצג כטרם נבחר". השורש שם
// היה RLS על holiday_centers — ראו 20260901_holiday_centers_rls.sql.
// נוסה כאן קודם מטמון כהסבר, והוא היה שגוי.
// ─────────────────────────────────────────────────────────────────────────────
