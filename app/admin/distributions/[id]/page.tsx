...
//
// ⚠️ בלעדיו Next.js הגיש HTML מוטמן: מוקד שנבחר באתר לא הופיע בטבלה,
// והתיקונים בשאילתה ובמיפוי לא השפיעו כלל — הם פשוט לא רצו. זה נראה
// כמו באג בנתונים בזמן שהנתונים היו תקינים לגמרי.
//
// ⚠️ כל נתיבי ה-API של המסך כבר מוגדרים כך; העמוד עצמו נשכח, והוא
// היחיד שהמשתמש באמת רואה.
// ─────────────────────────────────────────────────────────────────────────────
