    ...
    <div dir="rtl">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3 mb-4">
        ...
        <div className="flex items-center gap-2 flex-wrap justify-end">
          ...
          {/* 🔴 כלי התחזוקה מוסתרים כברירת מחדל — ראו ActionsCtx.
              המסך נועד לצפייה; מרכז בקרה, מיזוגים, בריאות העץ ושאר הכלים
              משנים את העץ, ואין להם מה לעשות על המסך בזמן סריקה רגילה. */}
          {actionsOn && (<>
