...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const data = sample?.mergeData ?? {
    ...
    'עיר': 'בני ברק',
    'מספר_ילדים': '7',
    // ⚠️ ערכי דוגמה למוקד — רק כשאין נמענים כלל. בשליחה אמיתית הערכים
    // מגיעים מהסנאפשוט של כל משפחה בנפרד.
    'מוקד': 'בני ברק, אזור סקולוב',
    'מוקד_עיר': 'בני ברק',
    'מוקד_כתובת': 'יואל 6 קומה 2',
    'מוקד_שעות': 'ימי רביעי וחמישי, 16:00–23:00',
    'מוקד_סטטוס': 'מחלק',
  }
