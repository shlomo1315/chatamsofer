...
2. בלחיצה על "שמירה והורדת טופס חתימת רב" הבקשה נשמרת בסטטוס
...
· **טופס חתימת רב** — נוצר אוטומטית עם פרטי המבקש וסדר הדורות מודפסים מראש.
...
· כיול טופס חתימת רב → הגדרות ← פורטל הלוואות ← עריכת הטופס
