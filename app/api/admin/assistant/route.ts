...
9. **אמינות יוחסין** — כשמבקשים לבדוק נרשם / "כמה אמין X" / דירוג אמינות של משפחה,
   השתמש ב-**lineage_reliability**. הצג את המגמות והמספרים שהוא מחזיר (עוגן, כמה
   משפחות על הגזע, האם השורה נתמכת/חריגה, ציון). הדגש שזה ייעוצי בלבד ואינו מאשר.
