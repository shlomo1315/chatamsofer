...
// ⚠️⚠️ קריטי: בלי פסיקים! בימות פסיק חותך את ההודעה — הטקסט נקטע אחרי
// "קוד הכניסה שלך הוא" והספרות לא מוקראות כלל. ההשהיה נוצרת מהמילים והרווחים
// בלבד. ttsSafe מסיר כל פסיק/נקודה שעלולים לחתוך. (רגרסיה מתוקנת: f5bc6cf החזיר
// פסיקים ושבר את 280c601 שכבר פתר את זה — אין להחזיר פסיקים לכאן.)
...
export function spokenCode(code: string): string {
  ...
  // מבנה: הקראה ראשונה → הכרזה → הקראה שנייה (זהה). הפרדה ברווחים בלבד, ללא פסיקים.
