...
export function attachmentsFor(type: ReqType, ctx: Ctx): AttachmentSpec[] {
  ...
  switch (type) {
    ...
    case 'loan':
      ...
      //
      // ⚠️ טופס חתימת רב הוא חובה גם כאן. בלעדיו ההגשה במייל הייתה הופכת
      ...
      return [
        ...
        { name: 'טופס-חתימת-רב', label: 'טופס חתום ע"י רב. הדפיסו את הטופס, החתימו את הרב, סרקו בצורה ישרה ואיכותית, וצרפו אותו כאן', required: true },
