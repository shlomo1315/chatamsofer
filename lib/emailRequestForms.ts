...
export function attachmentsFor(type: ReqType, ctx: Ctx): AttachmentSpec[] {
  ...
  switch (type) {
    ...
    case 'loan':
      ...
      return [
        { name: 'טופס-חתימת-רב', label: 'טופס חתימת רב — חתום ע"י רב. הדפיסו את הטופס, החתימו את הרב, סרקו ישר ובאיכות גבוהה וצרפו כאן. ⚠️ טופס עקום, חתוך או מטושטש לא ייקלט', required: true },
