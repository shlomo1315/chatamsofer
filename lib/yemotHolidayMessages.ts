...
export const HOLIDAY_MESSAGE_META: HolidayMsgMeta[] = [
  ...
  },
  {
    ...
    defaultText: 'לתשומת לב, לאחר בחירת מוקד, בהמשך החודש לקראת ימי החלוקה, ' +
      ...
      'ברגע שתקבלו את השובר תקבלו על כך הודעה אוטומטית בטלפון שלכם, ' +
      'ועל גבי השובר יופיעו הכתובות הימים והשעות שבהם תוכלו לאסוף את הכרטיס. ' +
  ...
  },
  {
    ...
    defaultText: 'נרשמתם בהצלחה למוקד החלוקה ב{center}. ' +
      'ברגע שתקבלו שובר במייל תקבלו על כך הודעה אוטומטית בטלפון שלכם, ' +
      'ועל גבי השובר יופיעו הכתובות הימים והשעות שבהם תוכלו לאסוף את הכרטיס. ' +
      'אין טעם לפנות בענין זה במייל או בטלפון. ' +
      'לא ניתן יהיה לקבל את הכרטיס במוקד אחר ולא ניתן יהיה לשנות את בחירתכם. ' +
      'בברכת חג כשר ושמח',
  },
  {
