...
export const HOLIDAY_MESSAGE_META: HolidayMsgMeta[] = [
  ...
  },
  {
    ...
    key: 'card_center_ended', label: 'החלוקה במוקד שלכם הסתיימה', allowAudio: false,
    placeholders: ['center'],
    defaultText: 'שימו לב, החלוקה במוקד {center} כבר הסתיימה, ' +
      'אין אפשרות לקבל כעת כרטיס. עמכם הסליחה',
    hint: 'הודעה דינמית — חובה לכלול {center}. נשמע במקש 2 כשהמוקד של המשפחה סיים לחלק.',
  },
  {
