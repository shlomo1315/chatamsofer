...
export const HOLIDAY_MESSAGE_META: HolidayMsgMeta[] = [
  ...
  // בבית מספר שאינו קיים, והנחת היסוד שלו הייתה שהוא פספס משהו.
  {
    ...
    defaultText: 'החלוקה טרם החלה ועדיין לא ניתן לשייך כרטיס ' +
      'נעדכן אתכם כשניתן יהיה לחבר את הכרטיס',
    hint: 'נשמע במקש 2 כשהאיסוף במוקדים עדיין סגור (pickup_open=false).',
  },
  {
