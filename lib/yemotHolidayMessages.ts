...
export const HOLIDAY_MESSAGE_META: HolidayMsgMeta[] = [
  ...
  //
  // 🔴 שיוך כרטיס הוא פעולה כספית שאי אפשר לבטל בטלפון. ת"ז אינה סוד —
  // היא מופיעה על כל מסמך — ולכן היא אינה מספיקה לאישור הפעולה.
  //
  // מטלפון הרשום בכרטסת: השליטה במספר היא הראיה, ואין הקשה נוספת.
  // מטלפון אחר: נדרש תאריך לידה. מי שיודע ת"ז אך לא תאריך לידה אינו בן הבית.
  {
    key: 'card_ask_birth', label: 'טלפון לא מזוהה — בקשת תאריך לידה', allowAudio: true,
    defaultText: 'שימו לב, המערכת אינה מזהה את מספר הטלפון שלכם. ' +
      'כדי לחבר את הכרטיס הקישו את תאריך הלידה שלכם בשמונה ספרות, ' +
      'של הבעל או של האשה',
    hint: 'נשמע במקש 3 כשהשיחה אינה מהטלפון הרשום בכרטסת.',
  },
  {
    key: 'card_birth_mismatch', label: 'תאריך הלידה אינו תואם', allowAudio: true,
    defaultText: 'תאריך הלידה שהקשתם אינו תואם לרשום במערכת, ' +
      'לבירור ניתן לפנות למשרד',
    hint: 'נשמע כשהתאריך שהוקש אינו תואם לאף אחד מתאריכי הלידה בכרטסת.',
  },
  {
    key: 'card_no_birth_on_file', label: 'אין תאריך לידה בכרטסת', allowAudio: true,
    defaultText: 'לא ניתן לאמת את פרטיכם בטלפון זה, ' +
      'לשיוך הכרטיס יש לפנות למשרד',
    hint: 'נשמע כשהמתקשר אינו מטלפון מוכר ואין בכרטסת תאריך לידה לאימות.',
  },
  {
