...
export const HOLIDAY_MESSAGE_META: HolidayMsgMeta[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    key: 'not_eligible', label: 'אינו רשום לחלוקה הנוכחית', allowAudio: true,
    defaultText: 'אינכם רשומים לחלוקת החגים הנוכחית',
    hint: 'נשמע כשהת"ז נמצאה באיגוד אך אינה רשומה לחלוקה הזו. ⚠️ אינה תלויה בשערי הפתיחה — אין לנסח אותה לפי מצב זמני.',
  },
  // ─────────────────────────────────────────────────────────────────────────
