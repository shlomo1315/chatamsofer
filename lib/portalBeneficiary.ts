...
export const BENEFICIARY_SELECT =
  'id, full_name, family_name, eligibility_status, rejection_reason, is_active, phone, phone2, spouse_phone, verified_phones, email, city, address, id_number, id_doc_type, spouse_name, spouse_id_number, marital_status, children_count, required_docs, children, lineage_node_id, lineage_manual, lineage_chain, lineage_fix_required, lineage_fix_note, lineage_fixed_at, created_at'
