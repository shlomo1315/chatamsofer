...
export const TABLES: TableSpec[] = [
  ...
  },
  {
    ...
    label: 'חלוקות חגים',
    perm: 'distributions',
    about: 'מסעי חלוקת חגים (תשרי/פסח וכו\'): שם החלוקה, שנה, החג, סכום למשפחה, תקציב כולל, תאריך החלוקה, האם הרישום פתוח, וסטטוס. הנרשמים לכל חלוקה נמצאים בטבלת "נרשמי חלוקה" (distribution_recipients).',
    columns: ['id', 'name', 'year', 'holiday', 'description', 'status', 'registration_open', 'amount_per_family', 'total_budget', 'distribution_date', 'created_at'],
    dateCol: 'created_at',
    searchCols: ['name', 'holiday'],
    statusCol: 'status',
  },
  {
  ...
  },
  {
    ...
    about: 'בקשות הלוואה מהגמ"ח: סכום מבוקש ומאושר (בדולרים $), מספר תשלומים, מטרה. ' +
      ...
      'rabbi_form_url = טופס אישור הרב החתום שהמבקש העלה.',
...
export const STATUS_HE: Record<string, Record<string, string>> = {
  ...
  loans: {
    // ⚠️ טיוטה שטרם הוגשה — המבקש הוריד את טופס אישור הרב וטרם החזירו
    // חתום. אינה מופיעה ברשימת ההלוואות ואינה ממתינה לטיפול הצוות.
    awaiting_rabbi_form: 'ממתינה לטופס אישור רב (טרם הוגשה)',
    pending: 'ממתינה לאישור',
