...
// תצוגה מקדימה קטנה של מסמך מצורף (תמונה או PDF) — קליק פותח בגודל מלא.
...
export default function DocThumb({
  ...
  return (
    <a
      ...
      title={name || 'פתח מסמך'}
      className="group relative block flex-shrink-0 rounded-lg border border-slate-200 overflow-hidden bg-slate-100 hover:border-indigo-400 hover:shadow-md transition-all"
